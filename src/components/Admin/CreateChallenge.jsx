...
const CreateChallange = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const localData = [newChallange, ...formData];
    ...
    function onFileUpload(e) {
        ...
        if (file) {
            ...
            imageToBase64(objectURL) // Path to the image
                .then((response) => {
        ...
        <div className='mb-10'>
            ...
            <div className='pl-[50px] sm:pl-[90px]  '>
                <form onSubmit={handleSubmit} className='flex flex-col w-72 gap-2'>
                    ...
                    <button type='submit' className=' my-16 bg-[#44924C] hover:bg-green-700 text-white w-[214px] h-[46px] rounded-[10px] px-[18px] py-[6px] font-medium text-[18px] text-center leading-5'>Create Challenge</button>
                </form>
            </div>
        </div>
    );
